...
public class BluetoothAdapterDemoActivity extends Activity {
	...
	private static final String TAG = com.example.attentionmonitor.BluetoothAdapterDemoActivity.class.getSimpleName();
...
//				tgStreamReader.connectAndStart();
	...
	public void showToast(final String msg, final int timeStyle){
		com.example.attentionmonitor.BluetoothAdapterDemoActivity.this.runOnUiThread(new Runnable()    
        {    
            public void run()    
            {    
